...
OFILES = main.o mylib.o text.o flappyBird.o font.o bg.o grass.o pipeTop.o pipeMiddle.o gameOver.o titleScreen.o

# The header files you have created.
# This is necessary to determine when to recompile for files.
# This should be a space (SPACE!) separated list of .h files
HFILES = mylib.h text.h flappyBird.h bg.h grass.h pipeTop.h pipeMiddle.h gameOver.h titleScreen.h
